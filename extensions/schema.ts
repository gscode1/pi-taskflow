...
const PhaseSchema = Type.Object(
	{
		...
		provider: Type.Optional(StringEnum(["pi", "agy"] as const, { description: "CLI provider for this phase's subagent", default: "pi" })),
		...
		timeoutMs: Type.Optional(Type.Number({ description: "Wall-clock timeout for this phase's subagent attempt in milliseconds (default 600000; 0 disables)." })),
